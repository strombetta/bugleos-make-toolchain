...
GCC_STAGE1_ARCHIVE := $(DOWNLOADS_DIR)/gcc-$(GCC_STAGE1_VERSION).tar.xz
GCC_STAGE1_SRC_DIR := $(SOURCES_DIR)/gcc-$(GCC_STAGE1_VERSION)
...
unpack-gcc1:
	@rm -rf $(GCC_STAGE1_SRC_DIR)
	@$(TAR) -xf $(GCC_STAGE1_ARCHIVE) -C $(SOURCES_DIR)
